...
class AyatWordBankProvider{

  Future<dynamic> getayatwordbank(var surahId) async {
    var client = http.Client();
    Iterable ayatwordBank;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ayatwordBank=jsonDecode(jsonString);

        // toast(response.body.toString());
        return  ayatwordBank.map((ayatwordbank) =>AyatWordBank.fromJson(ayatwordbank) ).toList();
